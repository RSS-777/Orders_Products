...
<template>
    <div class="form__buttons d-flex justify-content-end align-items-center gap-2 p-4">
        <button type="button" class="btn form__btn form__btn--cancel text-white" @click="handleCancel">
            отменить
        </button>

        <button :type="typeBtnConfirm"
            class="btn form__btn form__btn--confirm bg-white text-danger rounded-5 px-4 shadow" :disabled="isLoading"
            @click="handleClick">
